...

{
	...
	std::cout << "vision " << vision << endl;
	std::cout << "gold " << goldNum << endl;
	std::cout << "tempName " << tempName << endl;
	std::cout << "itemSlot " << itemSlot << endl;
	std::cout << "items " << items << endl;

	for(int i = 0; i < 12; i++){
		std::cout<<"equips:"<< i << ": " << equipment[i]<<endl;
	}

	for(int i = 0; i < abilities.size(); i++){
		for(int j = 0; j < 10; j++){
			cout << abilities.at(i)[j] << endl;
		}
	}
