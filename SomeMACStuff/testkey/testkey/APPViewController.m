...
@interface APPViewController () <THPinViewControllerDelegate>
...
@property (nonatomic) IBOutlet UIButton* test;
...
-(BOOL) createPinViewController:(THPinViewController *)pinViewController isPinValid:(NSString *)pin
{
    self.correctPin=pin;
    return false;
